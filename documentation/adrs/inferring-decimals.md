...
This library cannot infer the purpose of the data it processes, and the desired data type cannot be determined solely by the minimum and maximum values, signing, and floating point length.
